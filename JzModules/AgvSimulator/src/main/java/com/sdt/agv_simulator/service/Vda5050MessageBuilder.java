...
//        agvInfo.setVersion(agvStatus.getVersion());
//        message.setAgvInfo(agvInfo);
//
//        // 构建agvState
//        Vda5050StateMessage.AgvState agvState5050 = new Vda5050StateMessage.AgvState();
//        agvState5050.setAgvState(agvStatus.getAgvState() != null ? agvStatus.getAgvState().getValue() : "IDLE");
...
//        velocityInfo.setVelocity(agvStatus.getVelocity() != null ? agvStatus.getVelocity() : 0.0);
...
//        loadInfo.setCurrentLoad(agvStatus.getLoadWeight() != null ? agvStatus.getLoadWeight() : 0.0);
//        loadInfo.setLoadCapacity(agvStatus.getLoadCapacity());
//        loadInfo.setLoadHandled(agvStatus.getLoadWeight() != null && agvStatus.getLoadWeight() > 0);
